                                    ...
                                    <div class="control-content" >
                                        ...
                                        <div class="slider-content" >
                                            <div class="value"><?php
                                                ...
                                                $connect = Connect();
                                                $result = $connect->query("SELECT data FROM statistic WHERE action_time = (SELECT MAX(action_time) FROM statistic WHERE device_id=1);");
                                        ...
                                        <button class="showbtn"><a href="index.php?option=home.php&tuychon=dieuchinhgiatriden.php">Setting</a></button>
                                    </div>
                                </div>
