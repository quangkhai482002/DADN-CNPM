...
<?php
// $sql1 = "SELECT distinct * FROM `device`, `statistic` where 
// device.device_id=statistic.device_id 
// ";
// $result1 = mysqli_query($conn, $sql1);

$sql1 = "SELECT * FROM `statistic` LEFT JOIN `device` ON
device.device_id=statistic.device_id 
";
$result1 = mysqli_query($conn, $sql1);
            ...
            ?>
                    ...
                    <div class="history c-12">
                        ...
                        <div class="history-content">
                            ...
                            <div class="htr-code c-2">Bật</div>
                            <div class="htr-action c-2">
                                <?php
                                echo $row1['device_name']
                                ?>
                            </div>

                            <div class="htr-dev c-2">
                                <?php
                                echo $row1['device_id']
                                ?>
                            </div>
                            <div class="htr-time c-3">
                                <?php
                                echo $row1['action_time']
                                ?>
                            </div>
                        </div>
                    </div>
