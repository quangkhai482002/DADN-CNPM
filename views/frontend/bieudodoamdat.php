...
$query = "
SELECT data, UNIX_TIMESTAMP(action_time) AS datetime FROM statistic WHERE device_id=6 AND DATE(action_time) = '" .$current_time. "'
";
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <br />
            <h2 align="center">Biểu đồ dữ liệu cảm biến độ ẩm đất</h2>
